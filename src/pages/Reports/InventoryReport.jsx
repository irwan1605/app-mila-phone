  ...
  return (
    <div className="p-4">
      <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-4 rounded-lg shadow mb-4">
        <h1 className="text-2xl font-bold">Inventory Report — Cilangkap  Pusat & Antar Toko</h1>
        <p className="text-sm opacity-90">
          Realtime stock overview.CILANGKAP PUSAT name: <span className="font-semibold">{PUSAT_NAME}</span>
        </p>
      </div>
        ...
        <table className="w-full text-sm border-collapse">
          <thead className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white">
            <tr>
              ...
              <th className="p-2 border">CILANGKAP PUSAT Qty</th>
