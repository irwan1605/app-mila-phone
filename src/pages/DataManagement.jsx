...
const cardsConfig = [
  ...
  },
  {
    ...
    title: "MASTER BARANG MOTOR LISTRIK",
    icon: FaBolt,
    gradient: "from-emerald-500 to-green-500",
  },
  {
    key: "barangSepedaListrik",
    title: "MASTER BARANG SEPEDA LISTRIK",
    icon: FaBolt,
    gradient: "from-emerald-500 to-green-500",
  },
  {
    key: "barangHandphone",
    title: "MASTER BARANG HANDPHONE",
    icon: FaBolt,
    gradient: "from-emerald-500 to-green-500",
  },
  {
    key: "barangAccessoriesListrik",
    title: "MASTER BARANG ACCESSORIES",
    icon: FaBolt,
    gradient: "from-emerald-500 to-green-500",
  },
  {
    key: "barangSparePartListrik",
    title: "MASTER BARANG SPARE PART",
